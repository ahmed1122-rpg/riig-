...
- قاد تنبيه CodeQL الملتبس إلى تقوية metrics بحد 60/دقيقة وreadiness بحد 120/دقيقة مع بقاء التشخيص متاحًا عند تعطل Redis. أما موضع التنبيه المتبقي فكان `onClose` الذي لا يستقبل HTTP ويعمل عند إغلاق Fastify فقط؛ صُنّف على GitHub كـfalse positive مع تعليل تدقيقي، بينما بقي توضيح دورة الحياة بجانب hook من دون suppression صوري.
