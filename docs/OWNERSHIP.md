...
| Character source preparation | `apps/api/src/character-rig`, `apps/worker-character`, `packages/export-adapters/src/character-rig-psd.ts` | Source rights, pixel identity, review audit, PSD integrity | Source benchmark, worker integration, Character Animator Golden |
