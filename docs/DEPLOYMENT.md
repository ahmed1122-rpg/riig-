...
[`BROWSER_SUPPORT.md`](BROWSER_SUPPORT.md). Chromium, Firefox, and WebKit
desktop/mobile-sized E2E are required release gates; they are not independent
evidence of branded Chrome/Edge, Firefox, Safari, or iOS support.
