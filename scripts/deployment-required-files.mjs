export const requiredDeploymentFiles = [
  ...
  "deploy/validate-trusted-proxy.sh",
  ...
  "security/trivy-unfixed-exceptions.json",
  "scripts/verify-dependency-audit.mjs",
  ...
  "scripts/verify-release-legal.mjs",
  "scripts/verify-release-promotion.mjs",
  "scripts/package-release-gate-evidence.mjs",
  ...
  "apps/api/migrations/044_malware_scanning.sql",
