...
import { canonicalLayerName, createUniqueLayerName } from "@motionprep/layer-domain";
...
import {
  applyImageGuidance,
  type ApplyImageGuidanceResult,
} from "./image-guidance-operations.js";
