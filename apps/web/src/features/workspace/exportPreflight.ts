...
function productionIssueMessage(issue: ProductionIssue): string {
  ...
  const messages: Record<ProductionIssue["code"], string> = {
    ...
    LAYER_OPACITY_INVALID: "توجد طبقة بقيمة شفافية خارج النطاق من 0 إلى 1.",
    LAYER_Z_INDEX_INVALID: "توجد طبقة بترتيب تكديس غير صالح.",
    LAYER_READING_ORDER_INVALID: "توجد طبقة بترتيب قراءة غير صالح.",
